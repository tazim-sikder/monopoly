...
square[1] = new Square("MISERY AVENUE", "PRICE $60", "#8B4513", 60, 3, 2, 10, 30, 90, 160, 250);
square[2] = new Square("DEATH CHEST", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[3] = new Square("BANE AVENUE", "$60", "#8B4513", 60, 3, 4, 20, 60, 180, 320, 450);
square[4] = new Square("CHURCH TAX", "PAY 10% OR $200", "#FFFFFF");
square[5] = new Square("RAILROAD TO RUINATION", "PRICE $200", "#FFFFFF", 200, 1);
square[6] = new Square("TURMOIL TERRACE", "PRICE $100", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
square[7] = new Square("CHANCE", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[8] = new Square("AGONY AVENUE", "PRICE $100", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
square[9] = new Square("DREAD DRIVE", "PRICE $120", "#87CEEB", 120, 4, 8, 40, 100, 300, 450, 600);
...
square[21] = new Square("TORTURE TERRACE", "PRICE $220", "#FF0000", 220, 7, 18, 90, 250, 700, 875, 1050);
square[22] = new Square("CHANCE", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[23] = new Square("EVIL AVENUE", "PRICE $220", "#FF0000", 220, 7, 18, 90, 250, 700, 875, 1050);
square[24] = new Square("SINISTER AVENUE", "PRICE $240", "#FF0000", 240, 7, 20, 100, 300, 750, 925, 1100);
square[25] = new Square("RAILROAD TO BRIMSTONE", "PRICE $200", "#FFFFFF", 200, 1);
square[26] = new Square("ANGER AVENUE", "PRICE $260", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[27] = new Square("ENVY AVENUE", "PRICE $260", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[28] = new Square("BLOOD WORKS", "PRICE $150", "#FFFFFF", 150, 2);
square[29] = new Square("GLUTTONY GARDENS", "PRICE $280", "#FFFF00", 280, 8, 24, 120, 360, 850, 1025, 1200);
...
square[37] = new Square("PRIDE PLACE", "PRICE $350", "#0000FF", 350, 10, 35, 175, 500, 1100, 1300, 1500);
square[38] = new Square("INFAMY TAX", "Pay $100", "#FFFFFF");
square[39] = new Square("DAMNATION", "$400", "#0000FF", 400, 10, 50, 200, 600, 1400, 1700, 2000);
